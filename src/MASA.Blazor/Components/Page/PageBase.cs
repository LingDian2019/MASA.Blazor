...
namespace MASA.Blazor
{
    public abstract class PageBase : IComponent, IHandleEvent, IHandleAfterRender
    {
        ...
        [Inject]
        protected internal IExceptionFilterProvider ExceptionFilterProvider { get; set; }
        ...
        {
            var context = new ExceptionContext(ex, this);

            if (ExceptionFilterProvider != null)
            {
                var filters = ExceptionFilterProvider.GetExceptionFilters();
